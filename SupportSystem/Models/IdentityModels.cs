...
namespace SupportSystem.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, CustomRole, Guid, CustomUserLogin, CustomUserRole, CustomUserClaim>
    {
        ...
        //    modelBuilder.Entity<IdentityUser>().ToTable("SupportSystemUsers").Property(p => p.Id).HasColumnName("UserId");
        //    modelBuilder.Entity<ApplicationUser>().ToTable("SupportSystemUsers").Property(p => p.Id).HasColumnName("UserId");
        //    modelBuilder.Entity<IdentityUserRole>().ToTable("SupportSystemUserRoles");
        //    modelBuilder.Entity<IdentityUserLogin>().ToTable("SupportSystemUserLogins");
        //    modelBuilder.Entity<IdentityUserClaim>().ToTable("SupportSystemUserClaims");
        //    modelBuilder.Entity<IdentityRole>().ToTable("SupportSystemRoles");
        //}
